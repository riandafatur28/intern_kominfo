...
export default function FormInisiasi({ open, onClose, onCreated }) {
    ...
    return (
        <Modal open={open} onClose={onClose} title="Buat Inisiasi Perubahan"
            footer={
            ...
            <form id="form-inisiasi" onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                    ...
                    <textarea name="description" value={form.description} onChange={handleChange}
                        placeholder="Contoh: Integrasi atau penambahan modul Mudik Gratis pada platform/website Majadigi"
                        required rows={4}
                ...
                <div className="space-y-1.5">
                    ...
                    <textarea name="reason" value={form.reason} onChange={handleChange}
                        placeholder="Contoh: Untuk memfasilitasi pengguna dalam mengakses informasi layanan mudik gratis yang disediakan oleh pemerintahan Provinsi Jawa Timur"
                        required rows={3}
                        className="w-full border border-border-light rounded-lg px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-brand-100 focus:border-brand-500 resize-none"
                    />
                </div>
