...
// Ikon yang digunakan sesuai kebutuhan desain
import { LayoutDashboard, User, LogOut, X, FileText } from 'lucide-react';

// 💡 Mengaktifkan useAuth milik Gita nanti jika sudah digabung
// import { useAuth } from '../../context/AuthContext';

// 🎯 HANYA MENU YANG ADA DI DESAIN KAMU
const navItems = [
    { to: '/dashboard', icon: LayoutDashboard, label: 'Dashboard' },
    { to: '/permintaan-persetujuan', icon: FileText, label: 'Permintaan Persetujuan' }, 
...
export default function Sidebar({ collapsed, onToggle }) {
    ...
    // 🎯 NAMA DIUBAH MENJADI SUSANTI (DATA TIRUAN SEMENTARA)
    const user = {
        name: 'Susanti',
        roles: ['Team Lead'],
        team: {
